...
\begin{figure}[!h]
	\centering
		\includegraphics[width = 0.7\textwidth]{Figures/iSubGen_figure_methodology_overview.pdf}
...
\begin{figure}[!h]
	\centering
		\includegraphics[width = 0.7\textwidth]{Figures/iSubGen_figure_methodolody_autoencoders.pdf}
		\caption{\textbf{iSubGen overview.}}
		\label{fig:isopure}
\end{figure}
...
\begin{figure}[!h]
	\centering
		\includegraphics[width = 0.7\textwidth]{Figures/iSubGen_figure_methodolody_correlations.pdf}
		\caption{\textbf{iSubGen overview.}}
		\label{fig:isopure}
\end{figure}
...
autoencoders <- list();
for(i in data.types) {
  autoencoders[[i]] <- create.autoencoder(
    data.type = i,
